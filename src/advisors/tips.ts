...
const builderTips: AdvisorTip[] = [
  ...
  {
    id: 'first_armory_complete',
    advisor: 'war',
    message: 'Your Armory is ready! Train Brawlers to defend.',
    condition: (w) => countPlayerBuildings(w, EntityKind.Armory) === 1,
    cooldown: 9999,
    priority: 95,
    oncePerGame: true,
    action: 'open-buildings',
  ...
  {
    id: 'first_tower_complete',
    advisor: 'war',
    message: 'Tower operational! It will auto-attack nearby enemies.',
    condition: (w) => countPlayerBuildings(w, EntityKind.Tower) === 1,
    cooldown: 9999,
    priority: 95,
    oncePerGame: true,
  },
