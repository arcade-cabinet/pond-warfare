...
export const UNIT_DIALOGUE: Partial<Record<EntityKind, DialoguePool>> = {
  [EntityKind.Commander]: pool({
    ...
    select_spam: ['Do you MIND?', 'I have a war to run!', 'Stop poking me!', 'That\'s it, I\'m filing a complaint.'],
  ...
  [EntityKind.Gatherer]: pool({
    ...
    gather: ['Ooh, shiny clams!', 'Timber!', 'These twigs won\'t gather themselves.', 'Heavy load...'],
