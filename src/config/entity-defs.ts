...
export const ENTITY_DEFS: Record<EntityKind, UnitDef> = {
  [EntityKind.Gatherer]: {
    hp: 30, speed: 2.0, damage: 2, attackRange: 40,
    isBuilding: false, isResource: false, spriteSize: 16, spriteScale: 2.5,
    clamCost: 50, twigCost: 0, foodCost: 1,
  },
  [EntityKind.Brawler]: {
    hp: 60, speed: 1.8, damage: 6, attackRange: 40,
    isBuilding: false, isResource: false, spriteSize: 16, spriteScale: 2.5,
    clamCost: 100, twigCost: 50, foodCost: 1,
  },
  [EntityKind.Sniper]: {
    hp: 40, speed: 1.6, damage: 8, attackRange: 180,
    isBuilding: false, isResource: false, spriteSize: 16, spriteScale: 2.5,
    clamCost: 80, twigCost: 80, foodCost: 1,
  },
  [EntityKind.Gator]: {
    hp: 60, speed: 1.8, damage: 6, attackRange: 40,
    isBuilding: false, isResource: false, spriteSize: 16, spriteScale: 2.5,
  ...
  [EntityKind.Snake]: {
    hp: 60, speed: 2.0, damage: 4, attackRange: 40,
    isBuilding: false, isResource: false, spriteSize: 16, spriteScale: 2.5,
  },
  [EntityKind.Lodge]: {
    hp: 1500, speed: 0, damage: 0, attackRange: 0,
    isBuilding: true, isResource: false, spriteSize: 32, spriteScale: 3,
    foodProvided: 4,
  },
  [EntityKind.Burrow]: {
    hp: 300, speed: 0, damage: 0, attackRange: 0,
    isBuilding: true, isResource: false, spriteSize: 32, spriteScale: 3,
    clamCost: 0, twigCost: 100, foodProvided: 4,
  },
  [EntityKind.Armory]: {
    hp: 600, speed: 0, damage: 0, attackRange: 0,
    isBuilding: true, isResource: false, spriteSize: 32, spriteScale: 3,
    clamCost: 250, twigCost: 150,
  },
  [EntityKind.Tower]: {
    hp: 500, speed: 0, damage: 10, attackRange: 200,
    isBuilding: true, isResource: false, spriteSize: 32, spriteScale: 3,
    clamCost: 200, twigCost: 250,
  },
  [EntityKind.PredatorNest]: {
    hp: 1000, speed: 0, damage: 0, attackRange: 0,
    isBuilding: true, isResource: false, spriteSize: 32, spriteScale: 3,
  },
  [EntityKind.Cattail]: {
    hp: 1, speed: 0, damage: 0, attackRange: 0,
    isBuilding: false, isResource: true, spriteSize: 16, spriteScale: 2.5,
    resourceType: ResourceType.Twigs, resourceAmount: 1000,
  },
  [EntityKind.Clambed]: {
    hp: 1, speed: 0, damage: 0, attackRange: 0,
    isBuilding: false, isResource: true, spriteSize: 16, spriteScale: 2.5,
    resourceType: ResourceType.Clams, resourceAmount: 25000,
  },
};
